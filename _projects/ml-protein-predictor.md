...
- Leverages attention mechanisms to capture long-range dependencies in protein sequences
- Trained on curated PDB datasets with 3-state and 8-state classification
